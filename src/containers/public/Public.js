    ...
    <div className='w-full h-screen flex flex-col relative bg-primary-100'>
      <div className='w-full h-full flex flex-auto '>
        ...
        <div className='relative flex-auto flex flex-col'>
          ...
          <div className={`${scrollTop === "false" ? "bg-transparent" : "bg-primary-100 "} ${isShowSideBarR ? '1400:right-[329px] right-0' : 'right-0'} left-[240px] px-[59px] flex fixed top-0 items-center h-[70px] z-50`}>
            <Header />
          </div>
        ...
        {isShowSideBarR === true && <div className='w-[329px] h-screen hidden 1400:flex flex-none animate-slide-left'>
          <SidebarRight />
        </div>}
      </div>
      {curSongId && <div className='z-50 h-[90px] fixed bottom-0 left-0 right-0'>
